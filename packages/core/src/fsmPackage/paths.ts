...
import type { FsmPackageDiagnostic, FsmPackageResult, PackagePath } from './types.js';
...
function validateRelativePathSyntax(relativePath: string, field: string): FsmPackageDiagnostic[] {
