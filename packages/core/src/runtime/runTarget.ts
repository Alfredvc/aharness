...
import type { LoadInstalledFsmOptions } from '../loader/index.js';
...
export type ResolvedInstalledFsmTarget = InstalledFsmTarget | InvalidFsmTarget;
...
export async function resolveInstalledFsmTarget(
  token: string,
  opts: ResolveFsmTargetOptions = {},
): Promise<ResolvedInstalledFsmTarget> {
...
export function buildInstalledFsmLoadOptions(target: InstalledFsmTarget): LoadInstalledFsmOptions {
  return {
