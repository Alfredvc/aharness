...
const RUN_EVENT_TYPES = [
  ...
  'sidecar.turn.timeout',
  'sidecar.item.started',
  'sidecar.item.completed',
  'sidecar.item.fileChange.patchUpdated',
  'sidecar.agentMessage.delta',
  'sidecar.rawResponseItem.completed',
  'sidecar.input_request.created',
  'sidecar.input_request.resolved',
  'sidecar.token.updated',
  'sidecar.notification.ignored',
  'sidecar.thread.close.warning',
  'sidecar.turn.interrupt.warning',
  'artifact.written',
  'submit.recorded',
  'transition.recorded',
  'hook.observed',
